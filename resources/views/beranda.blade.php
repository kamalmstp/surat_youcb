                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle" align="center">
                                    {{\Carbon\Carbon::parse($masuk->created_at)->format('l, j F Y')}}
                                </td>
                                ...
                                <td style="vertical-align: middle" align="center">
                                    <span class="label label-{{$masuk->isDisposisi == true ? 'success' : 'danger'}}" style="text-transform: uppercase;font-size: 18px">
                                        <i class="fa fa-{{$masuk->isDisposisi == true ? 'check' : 'times'}}"></i>
                                    </span>
                                </td>
                                <td style="vertical-align: middle" align="center">
                                    <a onclick='lihatSurat("{{$masuk->id}}", "masuk", "{{$lbrSM}}", "{{$indexSM}}")' class="btn btn-dark btn-sm" style="font-size: 16px" data-toggle="tooltip" title="Lihat Surat ({{$lbrSM}} lembar)" data-placement="left"><i class="fa fa-images"></i>
                                    </a>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: middle" align="center">{{$no++}}</td>
                                <td style="vertical-align: middle" align="center">
                                    {{\Carbon\Carbon::parse($keluar->created_at)->format('l, j F Y')}}
                                </td>
                                <td style="vertical-align: middle">
                                    <table>
                                        <tr>
                                ...
                                <td style="vertical-align: middle" align="center">
                                    @if($keluar->status == 0)
                                    <span class="label label-warning" style="text-transform: uppercase">Diproses</span>
                                    ...
                                    <span class="label label-primary" style="text-transform: uppercase">Valid</span>
                                ...
                                <td style="vertical-align: middle" align="center">
                                    ...
                                    <a onclick='lihatSurat("{{$keluar->id}}","keluar","{{$lbrSK}}", "{{$indexSK}}")' class="btn btn-dark btn-sm" style="font-size: 16px" data-toggle="tooltip" title="Lihat Surat ({{$lbrSK}} lembar)" data-placement="left">
                                        <i class="fa fa-images"></i>
                                    </a>
                                    @else
                                    <a href="{{route('pdf.surat-keluar', ['id' => encrypt($keluar->id)])}}" target="_blank" class="btn btn-dark btn-sm" style="font-size: 16px" data-toggle="tooltip" title="Lihat Surat" data-placement="left">
