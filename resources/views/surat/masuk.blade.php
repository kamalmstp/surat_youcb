            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        ...
                        <li><a id="btn_create" data-toggle="tooltip" title="Buat Surat" data-placement="right"><i class="fa fa-plus"></i></a></li>
                        @endif
                    </ul>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle" align="center">
                                    @if(Auth::user()->isPengolah())
                                    <div class="btn-group">
                                        <button onclick='editSuratMasuk("{{$masuk->id}}")' type="button" class="btn btn-warning btn-sm" style="font-weight: 600" {{$masuk->isDisposisi == true ? 'disabled' : ''}}>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('disposisi',['id' => encrypt($masuk->id)]) }}" type="button" class="btn btn-info btn-xs">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li>
                                                <a href="{{route('delete.surat-disposisi',['id' => encrypt
                                                            ($masuk->getSuratDisposisi->id)])}}" data-surat="disposisi" class="delete-surat">
                                                    <i class="fa fa-trash"></i>&ensp;Hapus Surat
                                                    Disposisi</a>
                                            </li>
                                            @endif
                ...
                <div class="x_content" id="content2" style="display: none">
                    <form method="post" action="{{route('create.surat-masuk')}}" id="form-sm" enctype="multipart/form-data">{{csrf_field()}}
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="tgl_surat" class="form-control datepicker" type="text" name="tgl_surat" placeholder="yyyy-mm-dd" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-thumbtack"></i></span>
                                    <select id="perihal_id" class="form-control selectpicker" title="-- Pilih Perihal Surat --" data-live-search="true" name="perihal_id" data-max-options="1" multiple required>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="perihal" class="form-control" type="text" name="perihal" placeholder="Perihal" required>
                                </div>
                            </div>
                            <!-- <div class="col-lg-5">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="nama" placeholder="Nama lengkap pengirim" type="text" class="form-control" name="nama_pengirim" required>
                                </div>
                            </div>
                            <!-- <div class="col-lg-5">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-university"></i></span>
                                    <input id="nama_instansi" placeholder="Nama instansi pengirim" type="text" class="form-control" name="nama_instansi">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-12">
                                ...
                                <input type="file" name="files[]" style="display: none;" accept="image/*" id="attach-files" multiple>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-images"></i></span>
                                    <input type="text" id="txt_attach" class="browse_files form-control" placeholder="Unggah file disini..." readonly style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="Ekstensi file yang boleh diunggah: jpg, jpeg, gif, png. Ukuran file maksimal: < 5 MB">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-title">
                    <small>File Surat Masuk <span onclick="showDeleteFiles()" class="pull-right" style="cursor: pointer;color: #2A3F54">
            ...
            <div class="card-read-more" id="btn_delete_fileSurat">
                <button class="btn btn-link btn-block" data-placement="top" data-toggle="tooltip" disabled title="Klik disini untuk menghapus semua file yang Anda pilih!">
...
<script>
    ...
    function editSuratMasuk(id) {
        ...
        $.get('{{route("edit.surat-masuk", ["id" => ""])}}/' + id,
            function(data) {
