@extends('layouts.mst')
@section('title', 'Halaman Admin: Tabel Admin | '.env('APP_NAME').' - Universitas Cahaya Bangsa')
@push('styles')
    <style>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle" align="center">
                                        <img class="img-responsive" width="100" alt="avatar.png"
                                             src="{{$admin->ava == "" || $admin->ava == "avatar.png" ?
                                                 asset('images/avatar.png') : asset('storage/admins/'.$admin->ava)}}">
                                    </td>
