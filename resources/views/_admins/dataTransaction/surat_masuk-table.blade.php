@extends('layouts.mst')
@section('title', 'Halaman Admin: Tabel Surat Masuk | '.env('APP_NAME').' - Universitas Cahaya Bangsa')
@push("styles")
    <style>
        td ul, td ol {
            margin: 0 -2em;
                    ...
                    <div id="content1" class="x_content">
                        ...
                        <table id="myDataTable" class="table table-striped table-bordered bulk_action">
                            ...
                            @foreach($masuks as $masuk)
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle">{{$masuk->id}}</td>
                        ...
                        <div class="row form-group">
                            ...
                            <form method="post" id="form-sm">
                                {{csrf_field()}}
                                <input id="sm_ids" type="hidden" name="sm_ids">
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(function () {
                    ...
                    swal({
                        ...
                        preConfirm: function () {
                            return new Promise(function (resolve) {
                                $.get("{{route('massPDF.surat-masuk', ['ids' => ''])}}/" + ids, function (data) {
            ...
            $('#btn_remove_app').on("click", function () {
                ...
                $("#sm_ids").val(ids);
                $("#form-sm").attr("action", "{{route('massDelete.surat-masuk')}}");
