...
<head>
    ...
    <style>
        ...
        #myPassword+.glyphicon,
        #myNew_password+.glyphicon,
        #myConfirm+.glyphicon {
            cursor: pointer;
            pointer-events: all;
        }
        ...
        .stepped-progress-bar>li.invalid~li {
            color: #7d7d7d;
        }

        .stepped-progress-bar>li.active~li::after,
        .stepped-progress-bar>li.invalid~li::after {
            background-color: #dfdfdf;
        }

        .stepped-progress-bar>li.active~li::before,
        .stepped-progress-bar>li.invalid~li::before {
            background-color: #dfdfdf;
            border-color: #dfdfdf;
            color: #7d7d7d;
            line-height: 2.5rem;
        ...
        .stepped-progress-bar>li.invalid {
            color: #7d7d7d;
        }
    </style>
</head>
...
<body class="nav-md">
                ...
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{route('beranda')}}" class="site_title">
                            <i class="fa fa-archive"></i> <span>SIAS yoUCB</span></a>
                    </div>
                    ...
                    <div class="sidebar-footer hidden-small">
                        ...
                        <a href="javascript:void(0)" data-toggle="tooltip" title="Pengaturan Akun" class="btn_settings">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li>
                                        <a href="javascript:void(0)" class="btn_editProfile">
                                            <span class="badge {{$bg}} pull-right">{{$label}}</span>
                                            <span>Profil</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" class="btn_settings"><i class="fa fa-user-cog pull-right"></i> Pengaturan Akun
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                            ...
                            <li role="presentation" class="dropdown">
                                ...
                                <ul id="menu2" class="dropdown-menu list-unstyled msg_list" role="menu">
                                    ...
                                    <li>
                                        <a href="{{ route('disposisi',['id' => encrypt($row->id)]) }}">
                                            <span class="image">
                                    ...
                                    <li>
                                        <a href="{{route('show.surat-keluar').'?q='.$row->no_surat}}">
                                            <span class="image"><img src="{{asset('images/sk.png')}}"></span>
                                            <span><span>{{$row->no_surat}}</span></span>
                                            <span class="message">
                    ...
                    <form method="post" action="{{route('update.profile')}}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="row form-group">
                                <img src="{{$ava}}" class="img-responsive show_ava" id="myBtn_img" style="margin: 0 auto;width: 50%;cursor: pointer" data-toggle="tooltip" data-placement="bottom" title="Allowed extension: jpg, jpeg, gif, png. Allowed size: < 2 MB">
                                <hr style="margin: .5em auto">
                                <div class="col-lg-12">
                                    <label for="myAva">Avatar</label>
                                    <input type="file" name="myAva" style="display: none;" accept="image/*" id="myAva" value="{{$auth->ava}}">
                                    <div class="input-group">
                                        <input type="text" id="myTxt_ava" value="{{$auth->ava}}" class="browse_files form-control" placeholder="Upload file here..." readonly style="cursor: pointer" data-toggle="tooltip" title="Allowed extension: jpg, jpeg, gif, png. Allowed size: < 2 MB">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-12 has-feedback">
                                    ...
                                    <input id="myName" type="text" class="form-control" maxlength="191" name="myName" placeholder="Full name" value="{{$auth->name}}" required>
                        ...
                        <div class="modal-body">
                            <div class="row form-group">
                                <div class="col-lg-12 has-feedback">
                                    ...
                                    <input id="myEmail" type="email" class="form-control" name="myEmail" placeholder="Email" value="{{$auth->email}}" {{Auth::guard('admin')->check() && $auth->isRoot() ? 'required' : 'readonly'}}>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-12 has-feedback">
                                    ...
                                    <input id="myPassword" type="password" class="form-control" minlength="6" name="myPassword" placeholder="Current Password" required>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-12 has-feedback">
                                    ...
                                    <input id="myNew_password" type="password" class="form-control" minlength="6" name="myNew_password" placeholder="New Password" required>
                                    <span class="glyphicon glyphicon-eye-open form-control-feedback right" aria-hidden="true"></span>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-lg-12 has-feedback">
                                    ...
                                    <input id="myConfirm" type="password" class="form-control" minlength="6" name="myPassword_confirmation" placeholder="Retype password" required>
                                    <span class="glyphicon glyphicon-eye-open form-control-feedback right" aria-hidden="true"></span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function checkRupiahValue() {
            var low = parseInt($("#lowest").val().split(',').join("")),
                input = $("#highest"),
